...
if (!empty($_POST)) {
    ...
    if (!$error) {
        ...
        if (addtax($pdo, $inc_amount, $user_id, $inc_receipt_date, $inc_cat_id)) {
            $success = true;
        }
    }
}
            ...
            <div class="col-md-5 bg-light p-3">
                ...
                <form class="form-horizontal text-dark" method="post">
                    <div class="mb-3">
                        ...
                        <input id="inc_amount" name="inc_amount" type="text" placeholder="Ex: 2500" class="form-control input-md">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="inc_receipt_date" name="inc_receipt_date" type="date" placeholder="Ex:11-01-2001" class="form-control input-md">
                        <p class="mb-0 text-danger"><?= $error ? 'Le champ est requis' : '' ?></p>
                    </div>
                    <div class="mb-3">
